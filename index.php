<?php
$heading = 'Sea atractivo para sus clientes';
$sub_heading='Destaque las virtudes de su marca o negocio.';
$cta_label = 'Call to action Button';
$cta_url = '#feature';
include('header.php');
?>
      <!-- Our Features Section -->
      <div id="feature" class="our-services section py-4">
        <h3 class="section-title text-center my-5">Features Section</h3>
        <!-- Features -->
      ...
      <!-- Our Blog Section -->
      <div id="blog" class="blog section section-invert py-4">
        ...
        <div class="container">
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">I am making an extra long card to display the power of a masonry gallery... I am making an extra long card to display the power of a masonry gallery... I am making an extra long card to display the power of a masonry gallery... I am making an extra long card to display the power of a masonry gallery...</p>
                    <a class="btn btn-primary btn-pill" href="#">Read More &rarr;</a>
                  </div>
                </div>
              </div>
          ...
          <div id="cards-image-overlay" class="py-4">
            <h4 class="text-center m-5">Cards Image Overlay</h4>
            <!-- Cards and Overlays -->
            <div class="row">
              <div class="card-deck">
                <div class="col-md-12 col-lg-6">
                  <div class="card text-white">
                    <img class="card-img" src="images/common/card-2.jpg" alt="Card image">
                    <div class="card-img-overlay">
                      <h4 class="card-title">Card without hyperlink</h4>
                      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer. PS: Test the responsiveness.</p>
                      <p class="card-text">Last updated 3 mins ago</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 col-lg-6">
                  <a href="#cards-image-overlay">
                  <div class="card text-white">
                    <img class="card-img" src="images/common/card-1.jpg" alt="Card image">
                    <div class="card-img-overlay">
                      <h4 class="card-title">Card with hyperlink</h4>
                      <p class="card-text">I am making an extra long card to display the power of a masonry gallery, but this one would break unfortunately. So don't.</p>
      ...
      <div id="testimonial" class="testimonials section py-4">
